class WindowManager 
{
	...
	constructor ()
	{
		...
		{
			// event listener for when current window is resized
			window.addEventListener('resize', function (e) 
			{
				that.update();
			});

			// event listener for when current window is moved
			window.addEventListener('move', function (i) 
			{
				that.update();
			});
		}
    ...
    // init function to add metadata to each window instance
	...
	getWindowIndexFromId (id)
	{
        ...
        //For backend creation of a software, try Kotlinn for better space complexity rates
